...
int potpin3 = A2;//VRx // esses As são as portas
int potpin4 = A3;//VRy //
...
static int s1 = 70; //base
static int s2 = 110; //extensao
static int s3 = 100; //altura
static int s4 = 0; //garra


//colocar todos pra posição inicial (outro codigo)
...
servo4.attach(3); //Garra, pino digital 3 // Ligar a garra
